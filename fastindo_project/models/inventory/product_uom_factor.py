...
class ProductUoMFactor(models.Model):
    ...
    conversion_factor = fields.Float(
        ...
        required=True,
        digits=(16, 2),
        help='Jumlah satuan dasar dalam 1 satuan alternatif. Contoh: Jika 1 Box berisi 100 Pcs, maka isi 100.'
    )
    ...
    def _compute_qty_available_alt_uom(self):
        ...
        for record in self:
            if record.conversion_factor > 0:
                # qkoneksi uom alternative ke uom utama qty on hand
