...
class ResPartner(models.Model):
    ...
    def _compute_partner_finances(self):
        for partner in self:
            ...
            # Sum up amount_residual from unreconciled move lines on receivable accounts
            # that have a credit balance (amount_residual < 0).
            domain = [
            ...
            # We take the absolute value because amount_residual is negative for credits
